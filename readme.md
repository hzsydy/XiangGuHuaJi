...
- 资源
  ...
  - 计算公式：下一回合的资源 = 上一回合的资源 + （土地收入 + 城市收入）* （1 - 腐败系数*土地面积）
    ...
    - 土地收入：你领土上所有资源之和
    - 城市收入：你领土上的总城市数，乘以Game::UNIT_CITY_INCOME

      - 这意味着流亡政府（没有自己领土，只是靠同盟领地中的城市苟活）也能领到来自城市收入的工资~~低保~~。
...
说明： 城市/兵力 在游戏中是一个意思（使用“兵力”一词代替城市是为了体现在军事阶段中的作用）。所有的城市/兵力一旦被放置，就不能主动移动或者撤回。

​	 ~~不然这就变成一个兵棋游戏了，这有违我们希望压制微操 提高运营的初衷~~

- 城市的建立与发展
  - 游戏开始时，一个国家有一个出生点，且出生点上有一个等级1的城市。
  - 国家可耗费 k * Game::UNIT_SAVING 的资源量，在本回合己方领土上建立一个k级的城市，或将自己某个城市的等级增加k级。也即，空地相当于0级城市。
  - 你也可以在同盟国的领土内建立你自己的城市。
    - 战术价值：在他国领土边境处英勇击敌夺得**自己**的领土，同时自己没有额外丢失领土的危险。
    - 风险：一旦同盟被取消，你将被迫以很低(Game::DEPRECIATION_COEF，直译“折旧系数”)比例的价格撤回这些没有建在本国领土上的城市；而且此时因为军通的问题，你新打出来的领土可能没有任何防御能力。
    - 一块地上可以同时分布不同AI的城市。
      - 一块土地上甚至可以同时分布两个正在战争中的国家的城市(AB同盟，AC同盟，BC战争；A的领土上同时出现BC)。稍后会说明，所有的攻击都是针对**领土**而不是针对兵力的。
- 影响力
  - 城市将对周围的大面积土地产生影响力。影响力随城市等级递增，随城市距土地的距离递减。
    - 我们采用高斯核（）
  - 军通
    - 影响力受到图的连通性影响。如果有 非同盟国家 阻隔，你的城市影响力将传播一格之后结束。
      - 例外：如果你的城市影响力溢出，城市影响力将从这一点继续往外传播，参见**连破判定**。
    - 如果我方领土被切断成了两部分，又没有盟友能够提供连通的道路，则两个区域的影响力分别计算。
      - 被一格宽度切断时，两侧都可以对切割点施加攻击影响力。但因为没有办法穿过切割点施加影响力，所以两侧防御影响力只能分别计算。
      - 战术价值：中央突破和包围都有着重大的战术意义。
- 土地主权判定
...
- 检查胜负
  - 一个失去所有城市的玩家将被迫终止游戏，剩下的领土变为无主领土。这与玩家还有没有领土/库存无关。~~没地方睡觉~~
    - 没有领土但是有城市的玩家，作为流亡政府还是有收入的，不会退出游戏，参见 **资源**。
